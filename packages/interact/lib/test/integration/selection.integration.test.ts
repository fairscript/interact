...
export function testSelectionOfAllRowsIntegration(context: DatabaseContext) {
...
export function testLimitedSelectionIntegration(context: DatabaseContext) {
...
export function testSingleRowSelectionIntegration(context: DatabaseContext) {
    it('from a single table', () => {
...
export function testMapSelectionIntegration(context: DatabaseContext) {
    const actual = context.run(
        employees
...
export function testVectorSelectionIntegration(context: DatabaseContext) {
...
export function testScalarSelectionIntegration(context: DatabaseContext) {
...
export function testRowCountSelectionIntegration(context: DatabaseContext) {
