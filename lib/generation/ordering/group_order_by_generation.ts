...
import {generateAggregationOperation} from '../selection/aggregation_selection_generation'
...
function generateGroupOrder(order: GroupOrderExpression): string {
    ...
    const generatedAggregationOperation = generateAggregationOperation(partOfKeyToTableAndProperty, parameterNameToTableAlias, operation)
